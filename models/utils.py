...
def plot_segmentation_images(
    ...
    os.makedirs(os.path.join(savefolder,classname), exist_ok=True)
    savefolder = os.path.join(savefolder,classname)
...
def plot_roc_curve(fpr, tpr, save_path=""):
    """
    Plots the ROC curve.

    Args:
        fpr: [np.array or list] False Positive Rate values.
        tpr: [np.array or list] True Positive Rate values.
    """
    plt.plot(fpr, tpr, 'b-')
